  ...
  return (
    <div className="resume">
      ...
      <section className="tech">
          <p>JavaScript/Typescript/Rust/Go/…</p>
        ...
        <div className="p-item">
          ...
          <ul>
            ...
            <li>
              ...
              <p>
              众包 NewJob标注平台，作为人工智能的水电煤，算法模型开发中需要大量的标注数据，而外包费用太贵，通过众包方式将打标任务分发出去来降低数据成本，带领合作伙伴自研图像、音视频打标平台。
              </p>
              <p>通过 rust wasm 优化 将图像 SLIC 超像素分割算法性能提升了 20 倍 9.006s 0.431s。极大提升打标效率。</p>
            </li>
            <h5>创新类项目</h5>
            <li>
