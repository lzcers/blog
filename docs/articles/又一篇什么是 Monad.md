...
![catmap](https://ksana.oss-cn-shenzhen.aliyuncs.com/articles/imgs/catmap.png)
...
![](https://ksana.oss-cn-shenzhen.aliyuncs.com/articles/imgs/monad_associativity.png)
...
// so，因此Monad函子构成一个范畴
```
![三角同一律](https://ksana.oss-cn-shenzhen.aliyuncs.com/articles/imgs/triangle_identity.png)
