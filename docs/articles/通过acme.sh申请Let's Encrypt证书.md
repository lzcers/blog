...
Tags: 编码 
PublishDate: 2017](\articles\imgs\8](\articles\imgs\27 17:43:02 
---
...
[acme.sh](https:](\articles\imgs\](\articles\imgs\github.com](\articles\imgs\Neilpang](\articles\imgs\acme.sh)是一个实现了ACME协议的linux命令行工具，那在windows上咋用？如果你是win10，那么安装Ubuntu子系统即可，具体使用看官方文档。
